...
def get_parser(ap=None):
    ...
    ap.add_argument(
        "--arduino-port", dest="arduino_port", required=False, default=None
    )
    ap.add_argument(
        "--html-port", dest="html_port", required=False, default=8000
    )
    ap.add_argument(
        "--json-port", dest="json_port", required=False, default=9000
    )
