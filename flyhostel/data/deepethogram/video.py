...
def build_key(flyhostel_id, number_of_animals, date_time, chunk, local_identity):
    key = f"FlyHostel{flyhostel_id}_{number_of_animals}X_{date_time}_{str(chunk).zfill(6)}_{str(local_identity).zfill(3)}"
    return key
