...
def load_experiment_features(experiment, identity=None, extra_bodyparts=[], min_time=None, max_time=None, on_overlap="raise"):
    ...
    for animal in tqdm(animals):
        ...
        cx = pose_frames["center_x"].to_numpy() - square_width // 2
        cy = pose_frames["center_y"].to_numpy() - square_width // 2
        frames=pose_frames["frame_number"].values
        ...
        ds = ds.sortby("time")
        ds = add_centroid_offset_single(ds, cx, cy)
