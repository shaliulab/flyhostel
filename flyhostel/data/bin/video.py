...
def get_parser(ap=None):
    ...
    ap.add_argument("--width", type=int, default=100, help="Expected width of the images taken from the video data or the cached segmentation_data")
    ap.add_argument("--height", type=int, default=100, help="Expected height of the images taken from the video data or the cached segmentation_data")
